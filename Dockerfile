...
# PRE-BUILT HOME DIRS
#
COPY jira-home-8.4.0-m0003.tar.bz2 /work-private/jira-home-8.3.0.tar.bz2
RUN chmod u+rx,g+rx,o+rx,a-w /work-private/jira-home-8.3.0.tar.bz2

COPY jira-shared-home-8.4.0-m0003.tar.bz2 /work-private/jira-shared-home-8.3.0.tar.bz2
